...
object Constants {
    ...
    const val ACTION_SET_SAMPLERATE = "action_set_samplerate"
    const val ACTION_SET_ENABLED_EFFECT = "action_set_enabled_effect"
    const val ACTION_SET_ENABLED_STEREO_WIDTH = "action_set_enabled_stereo_width"
    ...
    const val ACTION_SET_ENABLED_COMPRESSOR = "action_set_enabled_compressor"
    const val ACTION_SET_THRESHOLD = "action_set_threshold"
    const val ACTION_SET_RATIO = "action_set_ratio"
    const val ACTION_SET_ATTACK = "action_set_attack"
    const val ACTION_SET_RELEASE_TIME = "action_set_release_time"
    const val ACTION_SET_GAIN = "action_set_gain"
    const val ACTION_SET_AUTO_GAIN = "action_set_auto_gain"
    const val ACTION_SET_DETECTION_TYPE = "action_set_detection_type"
    const val ACTION_SET_THRESHOLD_WIDTH = "action_set_threshold_width"
    const val ACTION_SET_SLEEP = "action_set_sleep"
    ...
    const val ENABLED_EFFECT = "enabled_effect"
    const val ENABLED_STEREO_WIDTH = "enabled_stereo_width"
    ...
    const val ENABLED_COMPRESSOR = "enabled_compressor"
    const val THRESHOLD = "threshold"
    const val RATIO = "ratio"
    const val ATTACK = "attack"
    const val RELEASE_TIME = "release_time"
    const val GAIN = "gain"
    const val AUTO_GAIN = "auto_gain"
    const val DETECTION_TYPE = "detection_type"
    const val THRESHOLD_WIDTH = "threshold_width"
